...
public class RelatorioDAO extends Conexao{
    ...
    public ArrayList relatorioDeFilial(String inicio, String fim)
        ...
        String  relatorioFilial = "SELECT FILIAL.ID_FILIAL, FILIAL.NOME_FILIAL, FILIAL.CIDADE_FILIAL, FILIAL.TEL_FIFLIAL, COUNT(DISTINCT PEDIDO.ID_PEDIDO) AS QTD, SUM(SERVICO.VALOR_SERV) AS TOTAL" +
        ...
        String  relatorioPedidoCliente = "SELECT CLIENTE.ID_CLIENTE, CLIENTE.NOME_CLIENTE, CLIENTE.SOBRENOME_CLIENTE, CLIENTE.EMAIL_CLIENTE, CLIENTE.TEL_CLIENTE, COUNT(DISTINCT PEDIDO.ID_PEDIDO) AS QTD, SUM(SERVICO.VALOR_SERV) AS TOTAL, FILIAL.NOME_FILIAL" +
